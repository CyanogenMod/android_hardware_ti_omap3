...
/* MGR module offsets */
#define CMD_MGR_ENUMNODE_INFO_OFFSET    0xDB00
#define CMD_MGR_ENUMPROC_INFO_OFFSET    0xDB01
#define CMD_MGR_REGISTEROBJECT_OFFSET   0xDB02
#define CMD_MGR_UNREGISTEROBJECT_OFFSET 0xDB03
#define CMD_MGR_WAIT_OFFSET             0xDB04

#ifndef RES_CLEANUP_DISABLE
#define CMD_MGR_RESOUCES_OFFSET         0xDB05
#endif

#define CMD_PROC_ATTACH_OFFSET          0xDB20
#define CMD_PROC_CTRL_OFFSET            0xDB21
#define CMD_PROC_DETACH_OFFSET          0xDB22
#define CMD_PROC_ENUMNODE_OFFSET        0xDB23
#define CMD_PROC_ENUMRESOURCES_OFFSET   0xDB24
#define CMD_PROC_GETSTATE_OFFSET        0xDB25
#define CMD_PROC_GETTRACE_OFFSET        0xDB26
#define CMD_PROC_LOAD_OFFSET            0xDB27
#define CMD_PROC_REGISTERNOTIFY_OFFSET  0xDB28
#define CMD_PROC_START_OFFSET           0xDB29
#define CMD_PROC_RSVMEM_OFFSET          0xDB2A
#define CMD_PROC_UNRSVMEM_OFFSET        0xDB2B
#define CMD_PROC_MAPMEM_OFFSET          0xDB2C
#define CMD_PROC_UNMAPMEM_OFFSET        0xDB2D
#define CMD_PROC_FLUSHMEMORY_OFFSET      0xDB2E
#define CMD_PROC_STOP_OFFSET            0xDB2F
#define CMD_PROC_INVALIDATEMEMORY_OFFSET 0xDB30

#define CMD_NODE_ALLOCATE_OFFSET        0xDB40
#define CMD_NODE_ALLOCMSGBUF_OFFSET     0xDB41
#define CMD_NODE_CHANGEPRIORITY_OFFSET  0xDB42
#define CMD_NODE_CONNECT_OFFSET         0xDB43
#define CMD_NODE_CREATE_OFFSET          0xDB44
#define CMD_NODE_DELETE_OFFSET          0xDB45
#define CMD_NODE_FREEMSGBUF_OFFSET      0xDB46
#define CMD_NODE_GETATTR_OFFSET         0xDB47
#define CMD_NODE_GETMESSAGE_OFFSET      0xDB48
#define CMD_NODE_PAUSE_OFFSET           0xDB49
#define CMD_NODE_PUTMESSAGE_OFFSET      0xDB4A
#define CMD_NODE_REGISTERNOTIFY_OFFSET  0xDB4B
#define CMD_NODE_RUN_OFFSET             0xDB4C
#define CMD_NODE_TERMINATE_OFFSET       0xDB4D
#define CMD_NODE_GETUUIDPROPS_OFFSET    0xDB4E

#define CMD_STRM_ALLOCATEBUFFER_OFFSET  0xDB60
#define CMD_STRM_CLOSE_OFFSET           0xDB61
#define CMD_STRM_FREEBUFFER_OFFSET      0xDB62
#define CMD_STRM_GETEVENTHANDLE_OFFSET  0xDB63
#define CMD_STRM_GETINFO_OFFSET         0xDB64
#define CMD_STRM_IDLE_OFFSET            0xDB65
#define CMD_STRM_ISSUE_OFFSET           0xDB66
#define CMD_STRM_OPEN_OFFSET            0xDB67
#define CMD_STRM_RECLAIM_OFFSET         0xDB68
#define CMD_STRM_REGISTERNOTIFY_OFFSET  0xDB69
#define CMD_STRM_SELECT_OFFSET          0xDB6A

/* Communication Memory Manager (UCMM) */
#define CMD_CMM_ALLOCBUF_OFFSET         0xDB80
#define CMD_CMM_FREEBUF_OFFSET          0xDB81
#define CMD_CMM_GETHANDLE_OFFSET        0xDB82
#define CMD_CMM_GETINFO_OFFSET          0xDB83
