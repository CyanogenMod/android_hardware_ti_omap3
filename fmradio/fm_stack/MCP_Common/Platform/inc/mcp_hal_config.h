...
*   DESCRIPTION:    
*
*     The constants in this file configure the MCP HAL layer for a specific platform and project.
*
*     Some constants are numeric, and others indicate whether a feature
*     is enabled (defined as MCP_HAL_CONFIG_ENABLED) or disabled (defined as
...
*/
#define MCP_HAL_CONFIG_FS_MAX_PATH_LEN_CHARS                             (1024)

/*
*   The maximum name of the file name part on the local file system (in characters)
*/
#define MCP_HAL_CONFIG_FS_MAX_FILE_NAME_LEN_CHARS                  	(128)

/*
*   The maximum number of directories that may be opened simultaqneosuly via the CP_HAL_FS_OpenDir()
*/
