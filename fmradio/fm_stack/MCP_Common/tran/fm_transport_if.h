 ...
 *
 * Returns:
 *      CCMA_STATUS_PENDING - Operation completed successfully.
 *
 *      CCMA_STATUS_INTERNAL_ERROR - A fatal error has occurred
 *
 * Returns:
 *      TBD.
 */
CcmaStatus FM_TRANSPORT_IF_SendFmVacCommand(McpU8 *hciCmdParms, 
