...
*/
FMC_STATIC void _FMC_CORE_HCI_ProcessHciEvent(struct hci_request	*hciEvent, 
...
//	_fmcTransportHciData[clientHandle].meToken.pUserData = &_fmcTransportHciData[clientHandle]; 
	...
	_FMC_CORE_HCI_CmdCompleteCb(&rq, clientHandle);
...
void _FMC_CORE_HCI_CmdCompleteCb(struct hci_request *hciEvent, _FmcCoreTransportClients clientHandle)
{
    FmcStatus   cmdCompleteStatus;
    FMC_U8      len = 0; 
    FMC_U8      *data = NULL;
...
void _FMC_CORE_HCI_ProcessHciEvent(struct hci_request *hciEvent, 
                                                        FmcStatus       *cmdCompleteStatus,
                                                        FMC_U8          **data,
                                                        FMC_U8          *len)
{
