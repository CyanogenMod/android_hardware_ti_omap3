...
#ifndef ANDROID_AUDIO_MODEM_GENERIC_H
#define ANDROID_AUDIO_MODEM_GENERIC_H

namespace android
{
class AudioModemInterfaceGeneric : public AudioModemInterface
{
    public:

                               AudioModemInterfaceGeneric();
        virtual                ~AudioModemInterfaceGeneric();
    ...
    *                       AUDIO_MODEM_FM | AUDIO_MODEM_TTY | AUDIO_MODEM_BLUETOOTH)
    ...
    * Return status based on values defined in include /utils/Errors.h
    */
    virtual status_t    setModemVoiceCallMultiMic(int multiMic=0);
    ...
    * Return status based on values defined in include /utils/Errors.h
    */
    virtual status_t    OpenModemVoiceCallStream();
    ...
    * Return status based on values defined in include /utils/Errors.h
    */
    virtual status_t    CloseModemVoiceCallStream();
    ...
    * Return status based on values defined in include /utils/Errors.h
    */
    virtual status_t    CloseModemAudioOutputStream();
